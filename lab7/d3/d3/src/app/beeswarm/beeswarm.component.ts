...
// const beeswarmFunct = require("./beeswarmFunction.js");

@Component({
  selector: 'app-beeswarm',
  templateUrl: './beeswarm.component.html',
  styleUrls: ['./beeswarm.component.css']
})
export class BeeswarmComponent implements OnInit {

  constructor() { }

  ngOnInit(): void {
    d3.json('/games').then((data: any) => console.log("hi"));
    // console.log(beeswarmFunct.BeeswarmChart());
